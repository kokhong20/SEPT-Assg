...
public class PAUnit
{
	...
	public static double setUnit(String att, boolean isStrokeWidth, double size)
	{
		if (att.matches("\\d+%{1}"))
		{
		...
		{
			return setSymbol(att, isStrokeWidth);
		}
	}
	...
	public static double setSymbol(String att, boolean isStrokeWidth)
	{
		if (!att.isEmpty())
		{
			// 10.10px or 10px or .10px are valid
