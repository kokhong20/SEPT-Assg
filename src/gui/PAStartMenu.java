...
public class PAStartMenu extends JFrame
{
    ...
    public PAStartMenu()
    {
        ...
        try
        {
            ...
            ImageIcon newFileIcon = new ImageIcon(newFileImg);
            
            openFileButton = new JButton(openFileIcon);
            openFileButton.setBounds(86, 36, openFileImg.getWidth(openFileButton), openFileImg.getHeight(openFileButton));
            openFileButton.setBorder(null);
            openFileButton.setBorderPainted(false);
            openFileButton.setVisible(true);

            newFileButton = new JButton(newFileIcon);
            newFileButton.setBounds(86, 200, newFileImg.getWidth(newFileButton), newFileImg.getHeight(newFileButton));
